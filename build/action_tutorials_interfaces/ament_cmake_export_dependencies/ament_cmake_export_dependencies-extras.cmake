...
set(_exported_dependencies "geometry_msgs;std_msgs;builtin_interfaces;nav2_msgs;action_msgs;geometry_msgs;std_msgs;builtin_interfaces;nav2_msgs;action_msgs;nav_msgs;unique_identifier_msgs;rosidl_runtime_c;rosidl_typesupport_interface;geometry_msgs;std_msgs;builtin_interfaces;nav2_msgs;action_msgs;nav_msgs;unique_identifier_msgs;geometry_msgs;std_msgs;builtin_interfaces;nav2_msgs;action_msgs;nav_msgs;unique_identifier_msgs")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(action_tutorials_interfaces_INCLUDE_DIRS "${_include_dirs}")
          endif()
